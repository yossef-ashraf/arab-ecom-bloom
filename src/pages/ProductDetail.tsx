...
const bookData: Book = {
  ...
  rating: 4.5,
  description: "كتاب شامل في البرمجة الحديثة يغطي أحدث التقنيات والممارسات في عالم البرمجة.",
        ...
        <div className="container mx-auto px-4">
          <nav className="flex mb-8" aria-label="Breadcrumb">
            <ol className="flex items-center space-x-2 space-x-reverse">
              ...
              <li>/</li>
              <li>
                <Link to={`/categories/${book.category}`} className="text-gray-500 hover:text-gray-700">
                  {book.category}
                </Link>
              </li>
              <li>/</li>
          ...
          <div className="mt-16">
            <Tabs defaultValue="specifications">
              ...
              <TabsContent value="description" className="p-6 bg-white rounded-md shadow-sm">
